Input your initial state, goal state and DFS graph in the input file
...
NOTE: 	The input file must be "input.txt"
	The output file must be "output.txt"
	The input and output file must be the same folder with the .exe
